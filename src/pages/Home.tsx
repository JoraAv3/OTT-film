...
export const Home = () => {
  ...
  /**
   * Performance Optimization: Memoizing filtered content lists.
   * By using useMemo, we ensure that these filtered arrays maintain reference stability
   * unless the underlying 'movies' or 'series' state changes. This allows the
   * React.memo wrapped MovieCarousel components to skip unnecessary re-renders.
   *
   * Expected Impact: Eliminates ~5-7 redundant carousel re-renders per Home page update.
   */
